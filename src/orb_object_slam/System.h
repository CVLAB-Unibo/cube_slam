...
public:
    ...
    System(const std::string &strVocFile, const eSensor sensor, bool use_loop_closing = true);
    ...
    // Save cuboids trajectories.
    // Call first Shutdown()
    // See format details at: http://www.cvlibs.net/datasets/kitti/eval_odometry.php
    void SaveTrajectoriesKITTI(const std::string &filename);
