...
public:
    ...
    int static PoseOptimization(Frame *pFrame); // only optimize one frame's pose. points fixed.
                                                // actually pnp, used in tracking
    ...
    // if bFixScale is true, optimize SE3 (stereo,rgbd), Sim3 otherwise (mono)   find sim3 transform
    // between two frames.
