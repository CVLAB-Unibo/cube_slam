      ...
      mbFinishRequested(false), mbFinished(true), mbStopped(false), mbStopRequested(false)
{
    ...
    mViewpointX = ORB_SLAM2::otherSettings["Viewer.ViewpointX"];
    mViewpointY = ORB_SLAM2::otherSettings["Viewer.ViewpointY"];
    mViewpointZ = ORB_SLAM2::otherSettings["Viewer.ViewpointZ"];
    mViewpointF = ORB_SLAM2::otherSettings["Viewer.ViewpointF"];
}
...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuFollowCamera("menu.Follow Camera", false,
                                         true); // NOTE first value is default value
    ...
    if (build_worldframe_on_ground) // better to click followcamera!
        s_cam.SetModelViewMatrix(
            pangolin::ModelViewLookAt(0, mViewpointZ, -mViewpointY, 0, 0, 0, 0.0, 0, 1.0));
