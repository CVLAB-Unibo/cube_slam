...
protected:
    ...
    // triangulate with previous keyframes to create map points. only way for mono. some points for
    // stere/rgbd. new triangulated points added to map. be put in recent buffer points, will be
    // checked in recent frames.
