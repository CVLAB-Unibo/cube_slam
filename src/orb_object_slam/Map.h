...
public:
    ...
    std::vector<KeyFrame *> GetAllKeyFrames(); // not sequential.... as use set, some frame might
                                               // delete due to mapping culling
...
protected:
    ...
    std::vector<KeyFrame *>
        mspKeyFramesVec; // sequential. only add, no delete. check isbad() before use
